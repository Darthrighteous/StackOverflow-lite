...
describe('AUTH ROUTE', () => {
  ...
  describe('to sign up with short pwd', () => {
    ...
    beforeAll((done) => {
      Request({ url: 'http://localhost:4001/v2/auth/signup', method: 'POST', json: shortPwdInput }, (error, response, body) => {
  ...
  describe('to sign up with no pwd', () => {
    ...
    beforeAll((done) => {
      Request({ url: 'http://localhost:4001/v2/auth/signup', method: 'POST', json: noPwdInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        data.user = body.user;
        done();
  ...
  describe('to sign up with no email', () => {
    ...
    beforeAll((done) => {
      Request({ url: 'http://localhost:4001/v2/auth/signup', method: 'POST', json: noEmailInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        data.user = body.user;
        done();
  ...
  describe('to sign up with no username', () => {
    ...
    beforeAll((done) => {
      Request({ url: 'http://localhost:4001/v2/auth/signup', method: 'POST', json: noUsernameInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        data.user = body.user;
        done();
  ...
  describe('to sign up with an invalid username', () => {
    ...
    beforeAll((done) => {
      Request({ url: 'http://localhost:4001/v2/auth/signup', method: 'POST', json: invalidUsernameInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        data.user = body.user;
        done();
  ...
  describe('to sign up with empty firstname', () => {
    ...
    beforeAll((done) => {
      Request({ url: 'http://localhost:4001/v2/auth/signup', method: 'POST', json: emptyFirstnameInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        data.user = body.user;
        done();
  ...
  describe('to sign up with empty lastname', () => {
    ...
    beforeAll((done) => {
      Request({ url: 'http://localhost:4001/v2/auth/signup', method: 'POST', json: emptyLastnameInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        data.user = body.user;
        done();
  ...
  describe('to log in with no password', () => {
    ...
    beforeAll((done) => {
      ...
      noPwdInput.password = undefined;
      Request({ url: 'http://localhost:4001/v2/auth/login', method: 'POST', json: noPwdInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        done();
      });
  ...
  describe('to log in with no email', () => {
    ...
    beforeAll((done) => {
      ...
      noEmailInput.email = undefined;
      Request({ url: 'http://localhost:4001/v2/auth/login', method: 'POST', json: noEmailInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        done();
      });
  ...
  describe('to log in with invalid email', () => {
    ...
    beforeAll((done) => {
      ...
      Request({ url: 'http://localhost:4001/v2/auth/login', method: 'POST', json: invalidMailInput }, (error, response, body) => {
        data.status = response.statusCode;
        data.body = body;
        done();
      });
